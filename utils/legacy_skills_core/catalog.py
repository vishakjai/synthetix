...
LEGACY_SKILLS: tuple[LegacySkillSpec, ...] = (
    ...
    LegacySkillSpec(
        id="php_legacy",
        name="PHP Legacy Skill",
        description="Analysis for legacy PHP web applications, controller/template mixes, sessions, inline SQL, and custom framework routing.",
        extensions=(".php", ".phtml", ".blade.php", ".twig", ".tpl", ".inc", ".phar"),
        content_tokens=(
            "<?php",
            "$_session",
            "$_post",
        ...
        analysis_focus=(
            "route/controller/template inventory",
            "session and auth flow profiling",
            "embedded SQL and data touchpoint extraction",
            "upload/export and background job discovery",
        ),
        maturity="beta",
    ),
    LegacySkillSpec(
