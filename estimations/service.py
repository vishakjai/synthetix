...
def _build_assumption_ledger_payload(*, artifact_id: str, business_need: str, risk_register: dict[str, Any]) -> dict[str, Any]:
...
def build_brownfield_estimate(
    *,
    ...
    raw_wbs = build_brownfield_wbs(chunk_manifest, risk_register, traceability_scores)
